...
**In plain terms:** this is the module where you build one complete unit of your course — lecture, slides, quiz, and assignment — as a repeatable pattern you'll copy for every other unit later. It's spread across three days on purpose.
