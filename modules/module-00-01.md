...
This module is just installing software and creating two folders (repos) that will hold your course. Nothing here requires coding experience.
...
Missing any of these? See [Setup: Git, VS Code, Morehouse Supercomputing Facility](../resources/setup-git-vscode-tacc.html) first.
