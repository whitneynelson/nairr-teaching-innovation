...
Git tracks changes for a whole folder of files instead of one document; it saves snapshots of your work over time, and GitHub is the website that stores those snapshots online so you (and your AI coding assistant) can access them from anywhere.
...
- **Merge conflicts**; unlikely this week since you're mostly working solo in your own repo, but if you see one, stop and ask rather than force-pushing over it; your AI coding assistant can also help you read and resolve a conflict if you paste it in and ask.
