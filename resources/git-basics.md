...
**In plain terms:** Git is like "track changes" for a whole folder of files instead of one document — it saves snapshots of your work over time, and GitHub is the website that stores those snapshots online so you (and Claude) can access them from anywhere.

</div>

## The five commands you'll actually use this week

| Command | What it does, in plain terms |
|---|---|
