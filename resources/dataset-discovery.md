...
Before you can build an HPC-based assignment, you need real (or realistic) data for students to work with. This page is about finding that data, then using an AI-powered coding assistant to sketch out the steps ("the workflow") for turning raw data into something your assignment actually uses.
...
- **Discipline-specific:** most fields have a standard go-to repository; e.g. genomics (NCBI/GEO), climate science (NOAA), social science (ICPSR), astronomy (NASA/MAST). Ask your AI-powered coding assistant: *"What are the standard public dataset repositories for [my field]?"*; it can point you toward the field-specific ones you may not know about.
...
Once you have a candidate dataset, don't jump straight into scripting; describe the shape of the problem to your AI-powered coding assistant first and let it help you plan:
...
2. Ask your AI-powered coding assistant to scaffold the starter notebook/script matching the workflow you just sketched
3. If you don't code, ask your AI-powered coding assistant to also produce a plain-language walkthrough of what the script does; this doubles as material for you to reference when writing the quiz
