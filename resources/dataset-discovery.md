...
**In plain terms:** before you can build an HPC-based assignment, you need real (or realistic) data for students to work with. This page is about finding that data, then using Claude to sketch out the steps ("the workflow") for turning raw data into something your assignment actually uses.
...
If your dataset is large, see [Moving Data Onto TACC](moving-data-tacc.html) for transfer options before you get to the actual assignment-building step.
